...
?>
    ...
    type: 'column',
            ...
            title: {
            text: 'Casos por mes en estado No pertientes'
            },
            xAxis: {
            categories: [
...
WHERE
    ec.estado_siniestro = 'NO PERTINENTE'   and  MONTH(fechaCreacionCaso) = $estado
GROUP BY id";
    $cuantosCali = 0;
...
WHERE
    ercl.estado_siniestro = 'NO PERTINENTE' and  MONTH(fechaCreacionCaso) = $estado
GROUP BY id ";
...
WHERE
    epc.estado_siniestro = 'NO PERTINENTE' and  MONTH(fechaCreacionCaso) = $estado
GROUP BY id ";
...
WHERE
    edc.estado_siniestro = 'NO PERTINENTE' and  MONTH(fechaCreacionCaso) = $estado
GROUP BY id ";
