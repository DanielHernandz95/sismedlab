...
<html>
    ...
    <body>
        ...
        ?>
        {!! Form::model($infoSiniestro, ['route'=>['UltimaArl.update',$infoSiniestro->idSiniestroPcl], 'method'=>'put'])  !!}
        ...
        <div style="margin-left: 50px;margin-right: 31px">
            <p>
                ...
                DIRECCION:<b>{{$infoSiniestro->direccionResi}}</b><br>
                TELEFONO:<b>{{$infoSiniestro->telefono}}</b><br>                
                CIUDAD:<b>{{$infoSiniestro->ciudad}} - {{$infoSiniestro->departamento}}</b><br><br>
            ...
            <p align="justify">
                ...
                con la legislación vigente (Ley 776 de 2002 – articulo 7), el <?php if ($infoSiniestro->tipo_evento == 'EL') { ?><b>enfermedad laboral  <?php } else { ?> </b> <b>accidente de trabajo <?php } ?></b> 
                mencionado no procede a 
                ...
                Anexo: <b>{{$infoSiniestro->anexosCarta}}</b><br>
