    ...
    <body>
        ...
        <div id="content" >
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="94%" bordercolor="#545545" style="margin-left: 30px; margin-top: -22px;text-align: left;font-size: 14px; color:#000; 1px solid #000;" >
                <tbody>
                    ...
                    <tr>                      
                        ...
                        <td colspan="2" style="border: 2px solid #000;" >&nbsp; <?php echo $now->format('d') . ' de ' . $meses[$now->format('n')] . ' de ' . $now->format('Y') ?></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="94%" bordercolor="#545545" style="margin-left: 30px; margin-top: -22px;text-align: left;font-size: 14px; color:#000; 1px solid #000;" >
                <tbody>
                    <tr>                      
                        <td colspan="2" style="border: 2px solid #000;" >&nbsp;NOMBRES Y APELLIDOS</td>
                    ...
                    <tr>          
                        ...
                        <td colspan="5"  style="border: 2px solid #000;" >&nbsp;{{$infoSiniestro->fechaNacimiento}}</td>
                        <td colspan="2"  style="border: 2px solid #000;" >&nbsp;EDAD</td>
                        <td colspan="2"  style="border: 2px solid #000;" >&nbsp;@php $cumpleanos = new \DateTime($infoSiniestro->fechaNacimiento);
                            $hoy = new \DateTime();
                            $annos = $hoy->diff($cumpleanos);
                            $edad = ($annos->y) @endphp {{$edad}}</td>
                    </tr>
                    <tr>          
                        <td  colspan="2" style="border: 2px solid #000;" >&nbsp;GENERO</td>
                        <td  colspan="9" style="border: 2px solid #000;" >&nbsp;{{$infoSiniestro->Genero}}</td>
                    </tr>
                    <tr>          
                        <td style="border: 2px solid #000;">&nbsp;ESTADO CIVIL</td>
                        <td style="border: 2px solid #000;">&nbsp;SOLTERO</td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp; @if($infoSiniestro->estadoCivil == '1') X @endif</td>
                        <td style="border: 2px solid #000;">&nbsp;CASADO</td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp;@if($infoSiniestro->estadoCivil == '2') X @endif</td>
                        <td style="border: 2px solid #000;">&nbsp;VIUDO</td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp;@if($infoSiniestro->estadoCivil == '3') X @endif</td>
                        <td style="border: 2px solid #000;">&nbsp;U.L </td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp;@if($infoSiniestro->estadoCivil == '4') X @endif</td>
                        <td style="border: 2px solid #000;">&nbsp;SEPARADO</td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp;@if($infoSiniestro->estadoCivil == '5') X @endif</td>
                    </tr>
                    <tr>          
                        <td style="border: 2px solid #000;">&nbsp;ESCOLARIDAD</td>
                        <td style="border: 2px solid #000;">&nbsp;PRIMARIA</td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp;@if($infoSiniestro->escolaridad == '1') X @endif</td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp;SECUND</td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp;@if($infoSiniestro->escolaridad == '2') X @endif</td>
                        <td style="border: 2px solid #000;">&nbsp;TECNICO</td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp;@if($infoSiniestro->escolaridad == '3') X @endif</td>
                        <td style="border: 2px solid #000;">&nbsp;UNIVERSITA </td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp;@if($infoSiniestro->escolaridad == '4') X @endif</td>
                        <td style="border: 2px solid #000;">&nbsp;OTRO</td>
                        <td style="border: 2px solid #000;" width="3%" >&nbsp;@if($infoSiniestro->escolaridad == '5') X @endif</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="94%" bordercolor="#545545" style="margin-left: 30px; margin-top: -22px;text-align: left;font-size: 14px; color:#000; 1px solid #000;" >
                <tbody>
                    <tr>                      
                        ...
                        <td style="border: 2px solid #000;" >&nbsp;{{$infoSiniestro->nombreEmpresa}}</td>
                    </tr>
                    <tr>    
                        <td Style="border: 2px solid #000;" >&nbsp;CARGO ACTUAL</td>
                        <td style="border: 2px solid #000;">&nbsp;{{$infoSiniestro->cargo}}</td>
                    </tr>
                    <tr>  
                        <td Style="border: 2px solid #000;" >&nbsp;ANTIGÜEDAD EN LA <br>&nbsp;EMPRESA</td>
                        <td style="border: 2px solid #000;">&nbsp;{{$infoSiniestro->antiguedad}}</td>
                    </tr>                       
                </tbody>
            </table>
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="94%" bordercolor="#545545" style="margin-left: 30px; margin-top: -22px;text-align: left;font-size: 14px; color:#000; 1px solid #000;" >
                <tbody>
                    ...
                    <tr>    
                        ...
                        <td style="border: 2px solid #000;">&nbsp;{{$infoSiniestro->historiaClinica}}</td>
                    </tr>
                    <tr>  
                        <td Style="border: 2px solid #000;" >&nbsp;ESTUDIOS</td>
                        <td style="border: 2px solid #000;">{{$infoSiniestro->resumenClinico}}</td>
                    </tr>                       
                </tbody>
            </table>
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="94%" bordercolor="#545545" style="margin-left: 30px; margin-top: -22px;text-align: left;font-size: 14px; color:#000; 1px solid #000;" >
                <tbody>
                    ...
                    <tr>                      
                        <td Style="border: 2px solid #000;" >&nbsp;{{$infoSiniestro->id}}</td>
                        <td Style="border: 2px solid #000;" >&nbsp;{{$infoSiniestro->tipoExamen}} </td>
                        <td Style="border: 2px solid #000;" >&nbsp;{{$infoSiniestro->ultimoResultado}}</td>
                    </tr>   
                </tbody>
            </table>
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="94%" bordercolor="#545545" style="margin-left: 30px; margin-top: -22px;text-align: left;font-size: 14px; color:#000; 1px solid #000;" >
                <tbody>
                    <tr>                      
                        <td Style="border: 2px solid #000;" >&nbsp;{{$infoSiniestro->concluciones}}</td>
                    </tr>                                      
                </tbody>
            </table>
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="94%" bordercolor="#545545" style="margin-left: 30px; margin-top: -22px;text-align: left;font-size: 14px; color:#000; 1px solid #000;" >
                <tbody>
                    <tr>                      
                        ...
                        <td Style="border: 2px solid #000;" >&nbsp;{{$infoSiniestro->name}}</td>          
                    </tr>  
                    <tr>                      
                        <td Style="border: 2px solid #000;" width="10%" >&nbsp;RM 3227  LSO 789</td>
                        <td Style="border: 2px solid #000;" >&nbsp;{{$infoSiniestro->fechcrea}}</td>          
                    </tr>  
                </tbody>
            </table>
            {!! Form::close() !!}
