...
use Phppot\InformeCalificacion;

/*
  use \Phppot\Product;
  use \Phppot\Consul_infor; */
require_once('dist/js/consultaInformes/calificacion/informeCalificacion.php');

error_reporting(0);


if (isset($_POST["exportCalificacion"])) {
    $consul_infor = new InformeCalificacion();
                    ...
                    <div class="row" id="seguimientoDiv">
                        <div class="card col-12">
                            <div class="card-header car contornoTitulo">
                                <h3 class="card-title letraTitulo" style="height: 5px;"><b>Informe calificacion</b></h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <label></label>
                                        <button type="button"  class="btn btn-block btn-outline-success btn-sm botones_letras"  id="btnBuscarInformeCalificacion" ><i class="fas fa-search"></i> Buscar</button>
                                    </div>
                                    <div class="col-sm-3">
                                        <label></label>
                                        <button type="submit" id="btnInformeGeneralCompletoCalificacion"   class="btn btn-block btn-outline-warning btn-sm botones_letras"><i class="fas fa-file-excel fa-lg" ></i> Exportar base completa</button>
                                    </div> 
                                    <div id="exportGeneralFiltro" class="ocultar col-sm-2">
                                        <form action="" method="post">     
                                            @csrf
                                            <label></label>
                                            <button type="submit" id="btnExport" name='exportCalificacion'  class="btn btn-block btn-outline-success btn-sm botones_letras"><i class="fas fa-file-excel fa-lg" ></i> Exportar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
