    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input  id="Txtid" name="Txtid"  type="hidden"  value="{{$infoSiniestro->idAdicionPcl}}" class="form-control c" onkeyup="mayus(this);"/>
            ...
            <form method="POST" id="guardarDiagnosticosAdicion"  action="" accept-charset="utf-8">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button  type="submit" id="reca"  class="btn btn-outline-success btn-sm botones_letras"><i class = "fas fa-check-square fa-lg " >&nbsp;</i>Guardar</button>
                </div>
            </form>
        </div>
    </div>
