    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input  id="Txtid" name="Txtid"  type="hidden"  value="{{$infoSiniestro->idSiniestroPcl}}" class="form-control c" onkeyup="mayus(this);"/>
            ...
            <form method="POST" id="guardarDiagnosticos"  action="" accept-charset="utf-8">
