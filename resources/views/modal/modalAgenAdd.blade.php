...
<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            ...
            <form class="form-horizontal" method="POST" action="" id="prueba">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12"> 
                            ...
                            <input type="text" name="" id="cedulaAfilido" class="form-control form-control-sm "  >
                        </div>
                        <div class="col-12" id="infoPaciente"></div>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-outline-danger btn-sm botones_letras" data-dismiss="modal">Cerrar</button>
                    <button  type="button" id="btnGuardarAgen" class="btn btn-outline-success btn-sm botones_letras" data-dismiss="modal"><i class = "fas fa-check-square fa-lg " >&nbsp;</i>Guardar</button>
                </div>
            </form>
        </div>
    </div>
