...
class FormatoNegacionController extends Controller {
    ...
    public function show($id) {
        ...
        $pdf = \PDF::loadView('pdf.formatoNegacionShow', compact('departamento', 'infoSiniestro', 'cie'));
    ...
    public function edit($id) {
        ...
        return view('pdf.formatoNegacion', compact('infoSiniestro', 'cie'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        $pdf = \PDF::loadView('pdf.formatoNegacionPdf', compact('edad', 'cc', 'TxtRm', 'TxtMedico', 'TxtConclusion', 'TxtultimoResultado', 'TxtTipoExamen', 'TxtId', 'TxtResumen', 'TxtEstudios', 'TxtHistoriaClinica', 'TxtAntiguedadEmpresa', 'TxtCargo', 'TxtNombreEmpresa', 'TxtFecha', 'TxtGenero', 'TxtEstadoCivil', 'TxtEscolaridad', 'infoSiniestro', 'cie'));
        //return $pdf->stream();
