...
class InformeReCalificacionController extends Controller {
    ...
    public function index() {
        ...
        return view('reportes.informeReCalificacion', compact('tipoSolicitud', 'entradaPcl', 'estados', 'usuarios'));
    }
