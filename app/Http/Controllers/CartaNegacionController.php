...
class CartaNegacionController extends Controller {
    ...
    public function show($id) {
        ...
        $infoSiniestro = tbl_cartanegaciones::where('idCartaNegaciones', '=', $id)
                ...
                ->join('tbl_siniestro_pcls as s', 's.llaveRecalificacion', '=', 'rc.idRecalificacionPcls')
                ->leftjoin('tbl_afiliados', 'tbl_afiliados.idAfiliado', '=', 's.llaveAfiliado')
                ...
                ->leftjoin('tbl_empresas', 'tbl_empresas.id_empresa', '=', 's.llaveEmpresaPcl')
                ->leftjoin('tbl_entrada', 'tbl_entrada.id_entrada', '=', 's.llaveCanalEntrada')
                ->leftjoin('tbl_quien_solicita', 'tbl_quien_solicita.id_quien_solicita', '=', 's.llaveQuienSolicita')
                ->leftjoin('tbl_solicitud', 'tbl_solicitud.id_solicitud', '=', 's.llaveTipoSolicitud')
                ->leftjoin('tbl_tipo_evento', 'tbl_tipo_evento.id_tipo_evento', '=', 's.llaveTipoEvento')
        ...
        $cie = tbl_cartanegaciones::where('idCartaNegaciones', '=', $id)
                ->join('tbl_recalificacion_pcls as rc', 'rc.idRecalificacionPcls', '=', 'tbl_cartanegaciones.llaveCartasnegacionRecalificacion')
                ->join('tbl_siniestro_pcls as s', 's.llaveRecalificacion', '=', 'rc.idRecalificacionPcls')
                ->leftjoin('tbl_cie_10_adicionados as a', 'a.llaveSiniestroPclDiagnostico', '=', 's.idSiniestroPcl')
        ...
        $pdf = \PDF::loadView('pdf.cartaNegacionShow', compact('departamento', 'infoSiniestro', 'cie'));
    ...
    public function update(Request $request, $id) {
        ...
        $pdf = \PDF::loadView('pdf.cartaNegacionPdf', compact('llaveCiudad', 'llaveDepartamento', 'telefono', 'direccionResi', 'departamento', 'infoSiniestro', 'cie', 'folio'));
        //return $pdf->stream();
