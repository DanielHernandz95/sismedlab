...
FROM
    ...
    tbl_cie_10 AS d ON d.id_cie_10 = c.llave_cie10_union
        INNER JOIN
    tbl_origen_diagnostico_adicional as o on o.id_origen_diagnostico_adicional = c.llave_tipo_cie10 WHERE llaveAdicionPcl='" . $_POST["idAdicionPcl"] . "'";
