...
$sql = "INSERT INTO `tbl_cie_10_adicionados` (`llave_cie10_union`, `descripcion` , `llaveSiniestroPclDiagnostico`, `moduloDeDx`) VALUES ('$dx','$descripcionDiagnostico', '$idSiniestro', 'RECALIFICACION');";
