...
foreach ($array_cie10 as $clave => $cie) {
    ...
    $query = $conexion1->query("INSERT INTO `tbl_cie_10_adicionados` (`llave_cie10_union`, `llave_tipo_cie10`, `descripcion`,`llaveSiniestroPclDiagnostico`) VALUES " . implode(',', $datoUnico));
}
