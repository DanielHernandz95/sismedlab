...
$consul_infor = new InformeGeneralConsulta();
$siniestros = $consul_infor->getAllSiniestroCompleto();
$consul_infor->exportSiniestrosCompleto($siniestros);

class InformeGeneralConsulta {
    ...
    public function getAllSiniestroCompleto() {
        $query = "SELECT 
    idAdicionPcl AS id,
    entrada,
    quien_solicita,
    ...
    IF(ad.llaveReCalificacionAdicion IS NOT NULL,
        ...
        IF(ad.llaveCalificacionAdcion IS NOT NULL,
            IF(sbc.sub_estados = 'ASIGNADO COMITE CODESS',
                'ABIERTO',
                IF(sbc.sub_estados = 'ASIGNADO COMITÉ POSITIVA ',
                    'ABIERTO',
                    IF(sbc.sub_estados = 'DEVOLUCION COMITÉ',
                        'ABIERTO',
                                                                        ...
                                                                        IF(sbc.sub_estados = 'CALIFICACION A CARGO DE OTRO PROVEEDOR',
                                                                            ...
                                                                            IF(sbc.sub_estados = 'LEVANTAR MASIVO',
                                                                                ...
                                                                                IF(sbc.sub_estados = 'PROMOVER PCL',
                                                                                    'ABIERTO',
                                                                                    IF(sbc.sub_estados = 'APERTURA DE RECALIFICACIÓN',
                                                                                        'ABIERTO',
                                                                                                ...
                                                                                                IF(sbpcl.sub_estados = 'CAMBIO DE DECRETO',
                                                                                                    ...
                                                                                                    IF(sbpcl.sub_estados = 'LEVANTAR VISADO',
                                                                                                        ...
                                                                                                        IF(sbpcl.sub_estados = 'CERTIFICACION AFILIACION ULTIMA ARL',
                                                                                                            'CERRADO TEMPORALMENTE',
                                                                                                            IF(sbpcl.sub_estados = 'PENDIENTE GARANTIA PROVEEDOR',
                                                                                                                'CERRADO TEMPORALMENTE',
...
GROUP BY idSiniestroPcl";
    ...
    public function exportSiniestrosCompleto($siniestros) {
