...
class InformeReCalificacion {
    ...
    public function getReCalificacion() {
        ...
        $canalEntrada = $_SESSION['canalEntradaRe'];
        $quienSolicita = $_SESSION['quienSolicitaRe'];
        $tipoSolicitud = $_SESSION['tipoSolicitudRe'];
        $estado = $_SESSION['estadoRe'];
        $subEstado = $_SESSION['subEstadoRe'];
        $asigando = $_SESSION['asigandoCa'];
        $fechaDesde = $_SESSION['fechaDesdeRe'];
        $fechaHasta = $_SESSION['fechaHastaRe'];
        ...
        if ($estado != null) {
            $TxtPreCalificacion = " AND  ercl.estado_siniestro = '$estado'";
        }

        if ($subEstado != null) {
            $TxtSubPreCalificacion = " AND  sbrcl.sub_estados = '$subEstado'";
        }
        if ($asigando != null) {
            $TxtPreCaliName = " AND urc.name = '$asigando'";
        }
...
";
    ...
    public function exportReCalificacion($siniestros) {
