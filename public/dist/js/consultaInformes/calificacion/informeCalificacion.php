...
class InformeCalificacion {
    ...
    public function getAllSiniestroCalificacion() {
        ...
        $canalEntrada = $_SESSION['canalEntradaCa'];
        $quienSolicita = $_SESSION['quienSolicitaCa'];
        $tipoSolicitud = $_SESSION['tipoSolicitudCa'];
        $estado = $_SESSION['estadoCa'];
        $subEstado = $_SESSION['subEstadoCa'];
        $asigando = $_SESSION['asigandoCa'];
        $fechaDesde = $_SESSION['fechaDesdeCa'];
        $fechaHasta = $_SESSION['fechaHastaCa'];
        ...
        if ($subEstado != null) {
            $TxtSubPreCalificacion = " AND  sbc.sub_estados = '$subEstado'";
        }
        if ($asigando != null) {
            $TxtPreCaliName = " AND ucl.name = '$asigando'";
        }
