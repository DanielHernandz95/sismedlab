...
class InformeAdicion {
    ...
    public function getAdicion() {
        ...
        $canalEntrada = $_SESSION['canalEntradaAdi'];
        $quienSolicita = $_SESSION['quienSolicitaAdi'];
        $tipoSolicitud = $_SESSION['tipoSolicitudAdi'];
        $estado = $_SESSION['estadoAdi'];
        $subEstado = $_SESSION['subEstadoAdi'];
        $asigando = $_SESSION['asigandoAdi'];
        $fechaDesde = $_SESSION['fechaDesdeAdi'];
        $fechaHasta = $_SESSION['fechaHastaAdi'];



        if ($fechaDesde != null and $fechaHasta != null) {
            $TxtFecha = " DATE(fechaCreacioonAdicin) BETWEEN '$fechaDesde' AND '$fechaHasta'";
        }
...
";
    ...
    public function exportsiniestrosAdicion($siniestros) {
